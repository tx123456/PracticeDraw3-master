...
public class Practice12MeasureTextView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float textlengt1 = paint1.measureText(text1);
        float textlengt2 = paint2.measureText(text2);

        canvas.drawText(text1, 50, 200, paint1);
        canvas.drawText(text2, 50 + textlengt1, 200, paint2);
        canvas.drawText(text3, 50 + textlengt1+textlengt2, 200, paint1);
    }
}
